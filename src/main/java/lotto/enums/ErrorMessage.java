...
public enum ErrorMessage {
    ...
    IS_NOT_MATCH_SIZE(String.format("%s개의 숫자를 입력해야 합니다.", ConstVariable.SIZE.getValue())),
    IS_NOT_DIGIT("숫자를 입력해야 합니다."),
    IS_NOT_DISTINCT("중복된 숫자를 입력하면 안됩니다."),
    NOT_VALID_AMOUNT(String.format("%d원 단위로 입력해야 합니다.", ConstVariable.UNIT.getValue())),
